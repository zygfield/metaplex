  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        let adjusted = (currentAmount * 1.25) - (currentAmount * 1.25) % (state.state.data.tickSize.toNumber() / LAMPORTS_PER_SOL);
    ...
    <Container disableGutters>
      ...
      {fairLaunch && (
          <div style={{ margin: 20, marginTop: 10 }}>
            <Grid container direction="row" wrap="nowrap" justifyContent="space-between">
              ...
              {phase !== Phase.Phase0 && (<Grid container md={4} direction="column">
                <Typography variant="body2" style={{ color: 'var(--text-color)' }}>
                  Median bid
                </Typography>
                <Typography
      ...
      <div className="right">
        <div className="row" style={{ alignItems: 'flex-end' }}>
          <img alt="" className="image1" src="/media/thumbnails/Solana_thumb_bull.png" />
          <img alt="" className="image2" src="/media/thumbnails/Solana_thumb_nft001.png" />
        </div>
        <div className="row" style={{ alignItems: 'flex-start' }}>
          <div className="image34">
            <img alt="" className="image3" src="/media/thumbnails/Solana_thumb_house.png" />
            <img alt="" className="image4" src="/media/thumbnails/Solana_thumb_plane.png" />
          </div>
          <img alt="" className="image5" src="/media/thumbnails/Solana_thumb_ufo.png" />
        </div>
      </div>
